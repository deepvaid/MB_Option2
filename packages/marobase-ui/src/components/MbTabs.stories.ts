...
const meta: Meta<MbTabsProps> = {
  ...
  render: (args) => ({
    ...
    template: `
      <div style="display:grid;gap:16px;align-items:start;justify-items:start;padding:24px;background:#f7f3ec;min-height:220px;">
        <MbTabs v-bind="args" :model-value="active" @update:modelValue="active = $event" />
        <p style="margin:0;color:#7a7466;font:500 12.5px/1.4 Inter, sans-serif;">Active tab: {{ active }}</p>
      </div>
    `
  })
};
...
export const PageHeaderTabs: Story = {
  render: () => ({
    ...
    template: `
      <section style="display:grid;gap:16px;padding:24px;background:#f7f3ec;min-height:260px;">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:16px;">
          <div>
            <div style="font:500 12px/1.2 Inter, sans-serif;color:#7a7466;margin-bottom:4px;">Workspace</div>
            <div style="font:600 22px/1.2 Inter, sans-serif;color:#1a1814;">Marketing Performance</div>
          </div>
          <div style="display:flex;gap:8px;">
            <button style="height:36px;border-radius:999px;border:1px solid #e6dfd1;background:#fdfbf7;color:#1a1814;padding:0 14px;font:600 13px/1 Inter, sans-serif;">Filters</button>
            <button style="height:36px;border-radius:999px;border:1px solid #e6dfd1;background:#fdfbf7;color:#1a1814;padding:0 14px;font:600 13px/1 Inter, sans-serif;">Last 30 days</button>
